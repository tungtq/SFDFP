...
*/
class Opencommercellc_Commercebug_Model_Collectorblocksandlayout extends Opencommercellc_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Opencommercellc_Commercebug') === 0)
            {
                continue;
            }
